...
export const WordCloudChart = (props) => {
  ...
  //     console.log("Yes ,load TikTok");
  //     mask.current = new Image();
  //     mask.current.src = tiktok;
  //   }

  mask.current.src = props.img;
  const option = {
    series: [
      {
        type: "wordCloud",
  ...
  return <EChartsReact option={option} style={props.style} theme="chalk" />;
};
